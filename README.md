...
## 🧪 Testing the Bluetooth Module {#testing-the-bluetooth-module}
...
1.  **Install nRF Connect**: On a second Android phone, install [[nRF
    > Connect for
    > Mobile]{.underline}](https://play.google.com/store/apps/details?id=no.nordicsemi.android.mcp)
